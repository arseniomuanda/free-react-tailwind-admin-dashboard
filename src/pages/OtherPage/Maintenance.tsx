...
export default function Maintenance() {
  return (
    <>
      <PageMeta
        title="Maintenance | TailAdmin - React.js Admin Dashboard Template"
        description="Maintenance page for TailAdmin - React.js Tailwind CSS Admin Dashboard Template"
      />
